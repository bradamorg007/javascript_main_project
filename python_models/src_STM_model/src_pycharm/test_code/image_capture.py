...
class ImageCapture:
    ...
    def save(self):
        ...
        fullpath = bz2.BZ2File(os.path.join(self.save_folder_path, filename), 'w')
    ...
    def process_capture_request(self, surface, label):
        ...
        elif self.capture_mode == 'feed':
            self.feed_object.feed_foward(input=surface)
    ...
    def save_config(self, save_folder_path):
        ...
        dict = self.__dict__
        filename = os.path.join(save_folder_path, 'image_capture_config.json')
